        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinWellnessScore = table.Column<int>(type: "int", nullable: false),
                    MaxWellnessScore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AverageWellnessScore = table.Column<int>(type: "int", nullable: false),
                    TotalHealthChecks = table.Column<int>(type: "int", nullable: false),
                    UnresolvedAlerts = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWellness", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserWellness_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WellnessAlerts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWellness_UserId",
                table: "UserWellness",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WellnessAlerts_UserId",
